...
#include "/home/tracs/work/tracs-master/include/TWaveform.h"
...
class __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate(R"ATTRDUMP(ROOT RTTI)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$include/TWaveform.h")))  TWaveform;
)DICTFWDDCLS";
